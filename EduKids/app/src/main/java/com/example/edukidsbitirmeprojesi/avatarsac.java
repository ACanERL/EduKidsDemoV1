...
public class avatarsac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avatarsac);
               ...
               setKarakter1();
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent x=new Intent(avatarsac.this,sarkilar.class);
                        startActivity(x);
                        finish();
                    }
                }, 2000);
    ...
    public  void  firstTime() {
        SharedPreferences sharedTime = getSharedPreferences("First1", Context.MODE_PRIVATE);
        if (sharedTime.getBoolean("firstTime1", true)) {
            sharedTime.edit().putBoolean("firstTime1", false).apply();
        } else {
            Intent r=new Intent(avatarsac.this,sarkilar.class);
            startActivity(r);
            finish();
